...
- Tracks fuente: `experiments/test_020_level3_spatial_model/level3_tracks.csv`.
- Robots asignados: `5`.
...
- `initial_side_fallback`: `available`, confianza `0.64`. Split robots by initial x_norm; mean clip spread=0.475.
...
- `initial_side_fallback`: `4` tracks.
- `initial_side_fallback_single_robot`: `1` tracks.
