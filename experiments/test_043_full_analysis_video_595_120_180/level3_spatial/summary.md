...
- Clips procesados: `video_595`.
- Filas exportadas: `206`.
- Filas rectificadas por homografia: `206`.
- Calibraciones manuales usadas: `0`.
- Calibraciones automaticas usadas: `1`.
...
- `overlay_comparison.csv` referencia `5` overlays originales ligeros de Nivel 2 para comparar frames seleccionados.
