...
- Tracks fuente: `experiments/test_043_full_analysis_video_595_120_180/level3_spatial/level3_tracks.csv`.
- Robots asignados: `1`.
...
- `initial_side_fallback`: `available`, confianza `0.55`. Split robots by initial x_norm; mean clip spread=0.000.
