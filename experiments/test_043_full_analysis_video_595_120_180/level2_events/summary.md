...
- Tracks: `experiments/test_043_full_analysis_video_595_120_180/tracking/tracks.csv`.
...
- `lvl2_evt_000002` `highlight_play` `provisional`: frames `172-173`, confianza `0.82`, senales `{'speed_px_per_sec': 4588.147, 'min_speed_px_per_sec': 250.0, 'ball_track_continuity': 'same_track', 'zone_axis': 'y'}`.

## Validacion Visual

- Overlays representativos encontrados/generados: `3`.
- Overlays pendientes: `2`.
