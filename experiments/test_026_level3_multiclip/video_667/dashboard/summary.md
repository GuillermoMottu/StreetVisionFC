...
- Clips integrados: `video_667`.
- Highlights enlazados: `60`.
- Metricas CSV: `17`.
...
- `primary_voronoi`: `voronoi_frame_video_667_120.png`.
- `primary_voronoi_original`: `voronoi_original_frame_video_667_120.png`.
