...
- Tracks: `experiments/test_017_level2_closure/video_667/tracks_level2.csv`.
...
- `lvl2_evt_000002` `highlight_play` `descartado`: frames `175-176`, confianza `0.1`, senales `{'speed_px_per_sec': 79.995, 'min_speed_px_per_sec': 250.0, 'ball_track_continuity': 'same_track', 'zone_axis': 'y'}`.
