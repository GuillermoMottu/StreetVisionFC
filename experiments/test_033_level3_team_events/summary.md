...
- Tracks fuente: `experiments/test_031_team_assignment/level3_tracks_with_teams.csv`.
- Eventos avanzados: `144`.
- Highlights rankeados: `142`.
- Segmentos de posesion candidata: `52`.
- Segmentos de posesion Nivel 2 reutilizables: `0`.
- Segmentos fallback desde interacciones Nivel 3: `52`.
- Segmentos de velocidad de balon: `142`.
- Overlays ligeros generados: `6`.

## Eventos Por Tipo

- `advanced_highlight`: `142`.
- `pass_chain`: `2`.
...
- `team_left`: `42` eventos.
- `team_right`: `102` eventos.
