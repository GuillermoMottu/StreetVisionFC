...
- Highlights con revision humana: `6`.
...
```bash
cd experiments/test_035_human_review/reel
bash render_reel_local.sh
```

- Salida esperada fuera de Git: `local_outputs/human_review/futbotmx_reviewed_reel.mp4`.
